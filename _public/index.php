...
<h2 class="blue-text text-darken-3 center-align">Welcome</h2>
<p class="center-align">
  ...
  proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
    ...
    <div class="section-1 grey lighten-4">
    <div class="container block">
            <div class="row">
        ...
        <div class="row">
            ...
            <div class="col s12 m4 l4">
                <div class="center">
                    <a href="#" data-activates="nav-mobile" class="button-collapse"><i class="small material-icons">library_books</i></a>
                    <h5>Lorem Ipsum</h5>
            ...
            <div class="col s12 m4 l4">
                <div class="center">
                    <a href="#" data-activates="nav-mobile" class="button-collapse"><i class="small material-icons">grade</i></a>
                    <h5>Lorem Ipsum</h5>
                    <p class="light center">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
            ...
            <div class="col s12 m4 l4">
                <div class="center">
                <a href="#" data-activates="nav-mobile" class="button-collapse"><i class="small material-icons">schedule</i></a>
